function iniciar() {
  ...
  let completo = new manual('completo', 'manuales/manual.html', 'imagenes/PORTADA.jpg');
  let primera = new manual('primera', 'manuales/recepcion.html', 'imagenes/AMARILLO.jpg');
